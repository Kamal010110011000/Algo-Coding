...
public class InsertNodeInSortedList {
	...
	public static void main(String args[]) {
		InsertNodeInSortedList l = new InsertNodeInSortedList();
		
		Node head = null;
		Node node = new Node(5);
		l.insertNode(head, node);
		
		Node head1 = new Node(7);
		Node node1 = new Node(4);
		l.insertNode(head1, node1);
		
		Node head2 = new Node(2);
		Node node2 = new Node(6);
		l.insertNode(head2, node2);
		...
		l.insertNode(head3, node3);
		
		Node node4 = new Node(50);
		l.insertNode(head3, node4);
	}
